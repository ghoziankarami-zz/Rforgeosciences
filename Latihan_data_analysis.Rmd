...
#removeing a variable from a data frame
...
#to arrange the data 
arrange(star, mass)
arrange(star, desc(mass)) descending
...
```{r}
#stat_density2d  is for density contour

ggplot(hdi, aes(HDI.2015, CPI.2015)) %>% + 
  geom_point(aes(color = Region), shape = 20, fill ="white", size = 3, stroke = 2) + theme_light() +
  labs(title = "corruption and Human Development") + stat_density2d()
